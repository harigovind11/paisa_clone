...
const kBluegrey = Color.fromARGB(255, 17, 19, 20); //BG
const kBluegreyShade = Color.fromARGB(255, 24, 28, 29);
const kHoverGrey = Color.fromARGB(117, 43, 77, 94);
const kLogoBlue = Color.fromARGB(255, 92, 167, 204);
const kGrey = Colors.grey; // arrow icons
const kGreyShade = Color.fromARGB(255, 58, 61, 63); //inside box titles
const kDeepBlue = Color.fromARGB(255, 16, 87, 134);

const kDarkBlue = Color.fromARGB(255, 9, 48, 75);

const kfillBlue = Color.fromARGB(255, 52, 159, 231);
